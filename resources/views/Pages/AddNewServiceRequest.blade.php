...
@section('content')
    ...
    <form class="form" action="{{ URL::to('/addServiceRequest') }}" method="post">
<input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="field">
                ...
                <div class="field-input">
                    <input type="text" name="id_servicio_consulta"/><br>
                </div>
        </div>
        <div class="field">
                <div class="field-label">
                ...
                <div class="field-input">
                    <input type="text" name="is_servicio_consulta_previo" /><br>
                </div>
        </div>
        <div class="field">
                <div class="field-label">
        ...
        <div class="field">
                ...
                <div class="field-input">
                    <input type="text" name="id_vehiculo" /><br>
                </div>
        </div>
        <div class="field">
                <div class="field-label">
        ...
        <div class="field">
                ...
                <div class="field-input">
                    <input type="text" name="fecha_servicio_solicitada" /><br>
                </div>
        </div>
        <div class="field">
                <div class="field-label">
                ...
                <div class="field-input">
                    <input type="text" name="fecha_servicio_efectuado"/><br>
                </div>
        </div>
        <div class="field">
                <div class="field-label">
        ...
        <div class="field">
                ...
                <div class="field-input">
                    <input type="text" name="id_prueba_adicional" /><br>
                </div>
        </div>
        <div class="field">
                <div class="field-label">
