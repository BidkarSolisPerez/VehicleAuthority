...
@section('content')
    ...
    <form class="form" action="{{ URL::to('/addVehicle') }}" method="post">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="field">
        ...
        <div class="field">
                ...
                <div class="field-input">
                    <input type="text" name="codigo_categoria"/><br>
                </div>
        </div>
        <div class="field">
                <div class="field-label">
        ...
        <div class="field">
                ...
                <div class="field-input">
                    <input type="text" name="codigo_modelo"/><br>
                </div>
        </div>
        <div class="field">
                <div class="field-label">
                ...
                <div class="field-input">
                    <input type="text" name="año_registro"/><br>
                </div>
        </div>
        <div class="field">
                <div class="field-label">
